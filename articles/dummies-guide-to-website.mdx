...
If you decide to not use a template, then you will be developing and programming it yourself. Which is not too difficult since there's alot of resources and tutorials on how to do that, but you will be creating all of the components and page templates by hand.
...
I use [Vercel](https://vercel.com/) to host my website, they have a generous free tier that let's me do everything I need to do. The best part about vercel is that you can hook it up to a github repository and the website will automatically update whenever you make changes!
