...
const Date = (props: any) => (
  ...
  >
    ...
    <path className='clr-i-outline clr-i-outline-path-11' d='M14 24h2v2h-2z' />
    <path className='clr-i-outline clr-i-outline-path-12' d='M20 24h2v2h-2z' />
    <path className='clr-i-outline clr-i-outline-path-13' d='M26 24h2v2h-2z' />
    <path
    ...
    />
    <path className='clr-i-outline clr-i-outline-path-16' d='M13 6h10v2H13z' />
