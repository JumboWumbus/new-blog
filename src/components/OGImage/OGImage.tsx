...
export const OGImage = ({ title, header, subtitle }: Props) => (
	<>
		<div
			style={{
				position: "relative",
			...
			<div
				style={{
					...
					opacity: "1",
					backgroundImage:
						"radial-gradient(ellipse, rgba(255,255,255,0) 10%, rgba(255,255,255,1) 80%)",
				}}></div>
			...
			<div
				...
				<h2
					...
					{header ? header : `BensDen ⟶ My fat website`}
				</h2>
				...
				<div
					...
					<h1
						...
						{title
							? title
							: `Developing, Designing, screaming...\n                          all at a high level`}
					</h1>
					<p
						style={{
							fontSize: 30,
