...
export default function NavBar() {
  ...
  return (
    <header className='p-4 dark:bg-coolGray-800 dark:text-coolGray-100'>
        ...
        <ul className='items-stretch hidden space-x-3 md:flex'>
          <li className='flex'>
            <a
              ...
              href='https://forum.rugrepo.com'
              className='flex items-center px-4 -mb-1 border-b-2  dark:border-transparent hover:dark:text-violet-400 hover:dark:border-violet-400 duration-300'
            >
              Forum
            </a>
          </li>
      ...
      <aside
        className={`w-full p-6 md:hidden  dark:bg-coolGray-900 dark:text-coolGray-100 ${
          isOpen ? 'block' : 'hidden'
        } `}
      >
